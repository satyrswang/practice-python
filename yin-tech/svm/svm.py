# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 17:25:21 2017
...
data,label = loadDataSet(r'D:\nnnnnnnnnnnnnnnnnnn\machinelearninginaction\Ch06\testSet_e.txt')
print data,label
            ...
            if ((labelMat[i]*Ei < -toler) and (alphas[i] < C)) or ((labelMat[i]*Ei > toler) and (alphas[i] > 0)):
              ...
              #  print alphaIold
                ...
                if (labelMat[i] != labelMat[j]):
                    ...
                    H = min(C, alphas[j] + alphas[i])#这里计算了a的上下界
...
print "the result of smosimple",b,alphas
