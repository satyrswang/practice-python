# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 16:46:54 2017
...
markers =[]
colors =[]
fw = open(r'C:\Users\yuqing.wang1\Desktop\testSet.txt','w')
for i in range(n):
    [r0,r1] = np.random.standard_normal(2) #根据标准正太分布
    print r0,r1
    myClass = np.random.uniform(0,1)#均匀分布
    if (myClass <= 0.16):
