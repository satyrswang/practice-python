...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  3 13:14:09 2017
...
inception_model = r'/Users/wyq/Documents/tensorflow_inception_graph.pb'

# 加载inception模型
graph = tf.Graph()
sess = tf.InteractiveSession(graph=graph)

##########tf.gfile.FastGFile,ParseFromString,tf.expand_dims(X-imagenet_mean, 0)
...
# 加载输入图像
input_img = cv2.imread(r'/Users/wyq/Documents/a.jpg')
